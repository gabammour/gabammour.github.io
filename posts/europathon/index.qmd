...
En tant que chef de projet, j'ai dû soutenir notre projet selon la methode du speach. Si la présentation orale ne sait pas passé comme prévu suite à une incompréhension lié à la présence ou l'absence de note pour s'aider, notre solution a été bien reçu par le jury. Nous avons obtenu le 3ème prix du jury (sur 6 groupes). Notre réflexion a également été appreciée par Nantes Métropole qui a ensuite décider de mener une étude de faisabilité sur le projet de douches mobiles.
